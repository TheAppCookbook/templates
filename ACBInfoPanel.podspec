Pod::Spec.new do |spec|
  ...
  spec.source_files     = 'templates/ACBInfoPanel/ACBInfoPanelViewController.{swift,xib}', 'templates/ACBInfoPanel/NSURL+ACBUrls.swift'
  spec.resources        = ['templates/ACBInfoPanel/ACBInfoPanelResources.xcassets']
